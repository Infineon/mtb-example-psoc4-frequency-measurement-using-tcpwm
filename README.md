...
[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
6. For [PSOC&trade; 4 HVPA-144K Evaluation Kit](https://www.infineon.com/cms/en/product/evaluation-boards/kit_psoc4-hvpa-144k_lite/), connect a jumper wire from PWM_FREQ_GEN (P0.2) output to COUNTER (P0.4) input.
7. For [PSOC&trade; 4 HVPA-SPM 1.0 Evaluation Kit](https://www.infineon.com/design-resources/finder-selection-tools/evaluation-board), connect a jumper wire from PWM_FREQ_GEN (P3.2) output to COUNTER (P0.3) input.
